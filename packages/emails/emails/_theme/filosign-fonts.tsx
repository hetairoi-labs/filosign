...
/**
 * Inter via Google CSS `@import`. Many clients strip `@import`; static `Font`
 * entries below register 400 / 500 / 600 as fallback when the import does not run.
 */
export function FilosignFonts() {
	return (
		<>
			<style
