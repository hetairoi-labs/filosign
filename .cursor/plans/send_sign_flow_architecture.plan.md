...
| `**POST /users/profile/sync-privy-email**`                                          | `identityToken`                                               | Same verifier family → `**verifiedPrivyEmailForWallet**` → update `**users.email**`, `[materializePendingInvitesForEmail](apps/server/lib/domain/sharing.ts)`.                                                                                                                                                                   |
